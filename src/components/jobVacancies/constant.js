...
export const countries = [
  ...
  export const Management  = [
    ...
    } ,
    {
      ...
      jobName: 'Chief Operation Officer – Automotive (COO) Location: Semarang, Indonesia',
      jobLocation: 'Semarang',
      jobdegree: 'Bachelor Degree',
      jobSalary: 'IDR 30,000,000 to IDR 40,000,000',
      JobList:{
  ...
  export const Marketing =[
    ...
    {
      jobHeading: 'Marketing Specialist (Experience in rubber compound industry / automotive)',
      jobcategory:'Marketing',
      jobName: 'Marketing Specialist (Experience in rubber compound industry / automotive)',
      jobLocation: 'Jawa Tengah',
      jobdegree: 'Bachelors Degree',
  ...
  export const Sales = [
    ...
    {
      jobHeading: 'Field Sales Supervisor (Bandung, Banjarmasin, Bekasi, Cirebon, Jambi, Jakarta, Medan, Makassar, Palembang, Pontianak, Surabaya, Tangerang, Bogor, Bandar Lampung, Semarang, PadangField Sales Supervisor)',
      jobcategory:'Sales',
