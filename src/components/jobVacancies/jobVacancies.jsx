  ...
  return (
    <div>
      ...
      <div className='job-search'>
        <div className=' d-flex justify-content-center job-post'>
            ...
            <div className='location'>
              ...
              <div className='categories'>
                ...
                <div className='d-flex flex-row flex-wrap job-category-item'>
                  ...
                  {/* Conditionally display remaining categories */}
                  {showAllCategories && remainingCategories.map((job, index) => (
                    ...
                    <div key={index} className="job-categorie-button m-1">
                      ...
                      >
                          {/* <button
                        className="button-all p-2"   style={{
                          backgroundColor: selectedCategory === job.category ? 'red' : 'initial',
                          color: selectedCategory === job.category ? 'white' : 'black',
                        }}
                        onClick={() => handleCategoryClick(job)}
                      ></button> */}
                  ...
                  {/* Button to toggle "More" and "Less" */}
                      ...
                      <div>
                        ...
                        <div className='job-deatils'>
                          ...
                          <div className='d-flex'>
                            ...
                            <div className='job-salary'>{data.jobSalary}</div>
                          </div>
                        </div>
                        <div className='apply-now-button'>
                          <button className='apply-buton ' onClick={()=>{navigate('/applyy',{state:data})}} >Apply Now</button>
