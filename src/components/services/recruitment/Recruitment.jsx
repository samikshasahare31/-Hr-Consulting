    ...
    <section>
      ...
      <div className="services-recruitment-container">
        <div className="services-recruitment-content">
          <h3 className="services-recruitment-heading">Find Your Perfect Match</h3>
          <h1 className="services-recruitment-title">Hire India’s Best Talent</h1>
          ...
          <div className="services-recruitment-buttons">
            ...
            <button className="services-apply-button" onClick={handleApplyTalentClick}>Apply As Talent</button>          
          </div>
        </div>
      ...
      <div className="services-pricing-container">
        <div className="services-pricing-content">
          ...
          <h2 className="services-pricing-title">Exclusive Recruitment Plans</h2>
          <p className="services-pricing-description">We offer tailored recruitment solutions to match your company's specific needs. Our pricing ranges from 15-20% of annual compensation, covering bonuses but excluding equity packages.</p>
          <p className="services-pricing-description">By partnering with us, you ensure access to top-tier candidates, seamless hiring processes, and ongoing support from our expert recruiters.</p>
            <button className="services-get-started-button">Get Started</button>
            <button className="services-upload-cv-button" onClick={handleUploadCVClick}>Upload CV</button>
        </div>
