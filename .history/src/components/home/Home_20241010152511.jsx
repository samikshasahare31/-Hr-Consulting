  ...
  return (
    <section>
          ...
          <div className='content'>
            <div className='text-section'>
              <div className='avatar-section'>
                <img src='/src/assets/images/images/icon-avatar.png' alt='Avatars' />
        ...
        <div className='partner-section'>
          ...
          <div className='partner-content'>
            ...
            <div className='partner-image-container'>
              <img
                src='/src/assets/images/images/Expert-local-knowledge.jpeg'
          ...
          <div className='cost-content'>
            <div className='cost-image-container'>
              <img
                src='/src/assets/images/images/cost-effective-solutions.jpg'
                alt='cost'
          ...
          <div className='compliance-content'>
            ...
            <div className='compliance-image-container'>
              <img
                src='/src/assets/images/images/compliance.jpeg'
                alt='Expert local knowledge in Indonesia'
                className='partner-image'
              />
            </div>
      ...
      <div className='one-stop'>
        ...
        <img
          src='/src/assets/images/images/one-stop-hr-services-for-your-business.jpeg'
          alt='HR Service'
